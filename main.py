...
def test():
    ...
    print("BubbleSort:", (end - start), "sec")

    start = time.time()
    sorts.selection_sort(list(uo_list))
    end = time.time()
    print("SelectionSort:", (end - start), "sec")

    start = time.time()
    sorts.insertion_sort(list(uo_list))
    end = time.time()
    print("InsertionSort:", (end - start), "sec")

    start = time.time()
    sorts.quick_sort(list(uo_list))
    end = time.time()
    print("QuickSort:", (end - start), "sec")

    start = time.time()
    sorts.merge_sort(list(uo_list))
    end = time.time()
    print("MergeSort:", (end - start), "sec")

    start = time.time()
    sort_list = list(uo_list)
    sort_list.sort()
    end = time.time()
    print("PythonSort:", (end - start), "sec")
